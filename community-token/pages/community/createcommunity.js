        ...
        <main className={styles.main}>
          ...
          {!success ? (
            ...
            <div className="bg-[#23024d] md:px-24 md:py-12 px-12 py-12 rounded-2xl flex justify-center grid grid-cols-1 gap-4 opacity-75 border-4 border-white">
              ...
              >
                <button className="md:px-16 px-4 font-bold py-4 bg-white rounded-full text-[#23024d] hover:bg-gray-100 mt-8 mb-8 block cursor-pointer text-center text-white">
                  Invite Bot
                </button>
              </a>
            </div>
