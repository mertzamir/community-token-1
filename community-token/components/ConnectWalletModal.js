          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-[#cdadff]">
            ...
            <div className="p-6">
              <p className="text-sm font-normal text-gray-500 dark:text-white">
                Connect with one of our available wallet providers. If
                you&apos;re using metamask on your mobile device use the
                metamask browser.
              </p>
              <ul className="my-4 space-y-3">
                ...
                <li className="flex justify-center">
                  ...
                  >
                    ...
                    <span className="flex ml-3 whitespace-nowrap w-48">
                      WalletConnect
                    </span>
                  </button>
                </li>
